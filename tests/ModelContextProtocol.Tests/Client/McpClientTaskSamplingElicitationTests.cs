...
public class McpClientTaskSamplingElicitationTests : ClientServerTestBase
{
    ...
    public async Task Client_WithTaskStore_CanExecuteSamplingAsTask()
    {
        ...
        await samplingCompleted.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken);
    ...
    public async Task Client_WithTaskStore_CanExecuteElicitationAsTask()
    {
        ...
        await elicitationCompleted.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken);
    ...
    public async Task Client_CanCancelTasks()
    {
        ...
        await samplingStarted.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken);
    ...
    public async Task Client_TaskStatusNotifications_SentWhenEnabled()
    {
        ...
        await Task.WhenAll(
            workingNotificationReceived.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken),
            completedNotificationReceived.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken));
    ...
    public async Task Client_SamplingHandlerException_ResultsInFailedTask()
    {
        ...
        await samplingAttempted.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken);
    ...
    public async Task Client_ElicitationHandlerException_ResultsInFailedTask()
    {
        ...
        await elicitationAttempted.Task.WaitAsync(TestTimeouts.DefaultTimeout, TestContext.Current.CancellationToken);
