...
public partial class McpServerResourceTests
{
    ...
    public async Task UriTemplate_CreatedFromParameters_LotsOfTypesSupported()
    {
        ...
        Assert.Equal("resource:///Hello", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = "resource:///Hello" } }, 
        ...
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?arg1=wOrLd" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?arg1=wo&arg2=rld" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        Assert.Equal("world", ((TextResourceContents)result.Contents[0]).Text);

        t = McpServerResource.Create((object a1, bool a2, char a3, byte a4, sbyte a5) => a1.ToString() + a2 + a3 + a4 + a5, new() { Name = Name });
        Assert.Equal($"resource:///Hello{{?a1,a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1=hi&a2=true&a3=s&a4=12&a5=34" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a1,a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1=10&a2=20&a3=30&a4=40&a5=50" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a1,a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1=1&a2=2&a3=3&a4=4&a5=5" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a1,a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1={DateTime.UtcNow:r}&a2={DateTimeOffset.UtcNow:r}&a3=http%3A%2F%2Ftest&a4=14e5f43d-0d41-47d6-8207-8249cf669e41&a5=1.2.3.4" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a2=1.0&a3=3&a4=4&a5=5" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a1,a2,a3}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1=123&a2=0001-02-03&a3=01%3A02%3A03" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a2,a3,a4,a5}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a2=true&a3=s&a4=12&a5=34" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
        ...
        Assert.Equal($"resource:///Hello{{?a1,a2,a4}}", t.ProtocolResourceTemplate.UriTemplate);
        result = await t.ReadAsync(
            new RequestContext<ReadResourceRequestParams>(server) { Params = new() { Uri = $"resource:///Hello?a1={DateTime.UtcNow:r}&a2={DateTimeOffset.UtcNow:r}&a4=14e5f43d-0d41-47d6-8207-8249cf669e41" } },
            TestContext.Current.CancellationToken);
        Assert.NotNull(result);
