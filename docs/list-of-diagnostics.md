...
| :------------ | :----- | :---------- |
| `MCP9001` | In place | The `EnumSchema` and `LegacyTitledEnumSchema` APIs are deprecated as of specification version `2025-11-25`. Use the nondeprecated enum schema APIs instead. |
