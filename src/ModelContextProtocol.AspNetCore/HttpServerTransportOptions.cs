...
public class HttpServerTransportOptions
{
    ...
    /// </list>
    /// For production use, implement a persistent storage solution. The in-memory implementation
    /// is suitable for development and testing only.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    /// The retry interval in milliseconds. The default is <see langword="null"/>, meaning no retry field is sent.
    /// </value>
    /// <remarks>
